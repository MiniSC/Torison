...
var _vw = _4a4._outerWidth() + _4a5._outerWidth();
if( opts.frozenAlign && _vw < _49e){
view.width(_vw);
}else{
view.width(_49e);
}
...
if( opts.frozenAlign){
if(_vw < _49e){_4a1.width(view.width()-_4a0._outerWidth());}else{_4a1.width(view.width()-_4a0.width());}
}else{
...
var _4c6=view.children("div.datagrid-view1");if( ooooo.frozenAlign){_4c6.addClass("datagrid-view1-2");}
var _4c7=view.children("div.datagrid-view2");if( ooooo.frozenAlign){_4c7.addClass("datagrid-view2-2");}
...
if(opts.frozenAlign){
_4cf(dc.header1,opts.frozenColumns,false);
_4cf(dc.header2,opts.columns,true);
}else{
...
opts.frozenAlign = (opts.frozenAlign==true||opts.frozenAlign=='right') ? true : false;
var _5bd=_4bd(this,opts.rownumbers, opts);
if(!opts.columns){
...
var cc=[];
if(opts.frozenAlign ? !_63f : _63f&&opts.rownumbers){
var _642=_640+1;
if(opts.pagination){
...
_644 = typeof _644=='string' ? _644.escapeHTML() : _644;
cc.push(_644);
}
}
cc.push("</div>");
